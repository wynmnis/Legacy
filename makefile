...
main: main.o main_AE.o main_CF.o main_PFA_Rader.o main_trash.o main_21845p.o build
...
main.o:main.cpp main_AE.cpp main_CF.cpp main_PFA_Rader.cpp main_trash.cpp main_21845p.cpp
