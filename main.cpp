...
int main()
{
	...
	precompute_gen.RA_powerof2_FFT(RA_out4, RA_in4, m, 0);
	...
	//precompute_gen.IDFT(RA_out4, DFT_out4, p, prou_p, precompute_gen.modular_m);
	precompute_gen.RA_powerof2_FFT(DFT_out4, RA_out4, m, 1);
	for(int i = 0; i < p; i++){
		cout << DFT_out4[i] << endl;
	}	
